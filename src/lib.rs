...
#[derive(Debug)]
pub struct ContextAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContextAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContextAPI processing");
    
    let mut processor = ContextAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContextAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContextAPIProcessor::new(false);
